(function (window, document, $) {
  ...
  var imgPath = window.location+'/img/';

  if ($('body').attr('data-framework') === 'laravel') {
    imgPath = $('body').attr('data-asset-path');
  }
      ...
      if (this.expanded === false) {
        if ($body.data('menu') == 'vertical-menu-modern') {
          $('.modern-nav-toggle')
            ...
            .replaceWith(
              feather.icons['sidebar'].toSvg({ class: 'd-none d-xl-block collapse-toggle-icon danger font-medium-4' })
            );
          $('.navbar-brand')
            .find('.brand-logo')
            .html('');
    ...
    collapse: function () {
      if (this.collapsed === false) {
        if ($body.data('menu') == 'vertical-menu-modern') {
          ...
          $('.navbar-brand')
            .find('.brand-logo')
            .html("<img class='img-fluid' src='"+imgPath+"/public/img/escudoPJEV.png' alt='Escudo PJEV' height='42'>");
        }
        this.transit(
          function () {
    ...
    bind_events: function () {
      ...
      function modernMenuExpand() {
        if ($body.data('menu') == 'vertical-menu-modern') {
          ...
          $('.navbar-brand').find('.brand-logo').html('');
          if ($body.hasClass('menu-collapsed')) {
        ...
        if ($body.hasClass('menu-collapsed') && $body.data('menu') == 'vertical-menu-modern') {
          setTimeout(function () {
            if ($('.main-menu:hover').length === 0 && $('.navbar-header:hover').length === 0) {
              ...
              $('.navbar-brand').find('.brand-logo').html("<img class='img-fluid' src='"+imgPath+"/public/img/escudoPJEV.png' alt='Escudo PJEV' height='42'>");
              if ($body.hasClass('menu-collapsed')) {
